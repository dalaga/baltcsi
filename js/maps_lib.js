...
var MapsLib = {
  ...
  fusionTableId:      "1kUiuXqZsRmWck_wG3V5frFonuqq_s9GLnsrzOncl",

  //MODIFY Google Fusion Tables API key. found at https://code.google.com/apis/console/
  //*Important* this key is for demonstration purposes. please register your own.
  googleApiKey:       "AIzaSyBJUL9ViVu_P1KHU1Gdwpb91azMwYMquyg",
  ...
  initialize: function() {
    ...
    $(":checkbox").prop("checked", "checked"); //ALAGA do the boxes are not checked when loaded.
    $("#result_box").hide();
